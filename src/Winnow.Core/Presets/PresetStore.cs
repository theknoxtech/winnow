...
namespace Winnow.Core.Presets
{
    ...
    {
        internal const string EmbeddedResourceName = "Winnow.Core.Presets.DefaultPresets.json";
        ...
        public PresetDocument BuildDelta()
        {
            ...
            {
                Comment = "Overrides for Winnow built-in presets. A matching id replaces a " +
